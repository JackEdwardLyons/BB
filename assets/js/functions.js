...
var background_settings = {
    ...
    use_script          : false,  // set to false if you want to set a custom background (css, video, etc)
};
...
function toggle_main_menu() {
    ...
    if (viewport().width <= window.xs_screen_max) {
        ...
        else { main_menu.addClass("menu_opened_on_xs").removeClass("menu_closed_on_xs").slideDown("fast", function() {
